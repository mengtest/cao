...
rwtNpcGroup[tBoxId.Normal]["Awards"]["RandomEvents"][1]["RandomToNormalEvents"][2]["Events"]["ChkUserTempData"][1]["Value"] = {0}
...
rwtNpcGroup[tCollect.Coffin]["Awards"]["RandomEvents"][1]["RandomToNormalEvents"][2]["Events"]["ChkUserTempData"][1]["Value"] = {0}
...
rwtNpcGroup[tCollect.Corpse]["Awards"]["RandomEvents"][1]["RandomToNormalEvents"][1]["MaxRate"] = 9000
...
rwtNpcGroup[tCollect.Corpse]["Awards"]["RandomEvents"][1]["RandomToNormalEvents"][2]["MinRate"] = 9001 
