...
rwtTask[tTask.nZiLvLianMeng_Pre3]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.RwardTask}
...
rwtTask[tTask.nZiLvLianMeng_Pre5]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.MercenaryTask}