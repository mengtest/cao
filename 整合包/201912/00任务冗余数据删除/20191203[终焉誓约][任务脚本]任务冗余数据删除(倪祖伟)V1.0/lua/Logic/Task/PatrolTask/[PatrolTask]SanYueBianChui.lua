--region [PatrolTask]SanYueBianChui.lua
--Purpose:		三月边陲巡查
--Creator: 		倪祖伟
--Created:		2019-10-17
--Modifier:		$Author: 倪祖伟 $
...
rwtTask[tSYBCXunCha.Task1]["Title"] = tLuaText[LANGUAGE_CONFIG][20944]
...
rwtTask[tSYBCXunCha.Task1]["AutoTaskDialog"] = tDialogId.Task1
...
rwtTask[tSYBCXunCha.Task1_4]["AcceptDialogId"] = tDialogId.Task1_4
...
rwtTask[tSYBCXunCha.Task1_7]["Title"] = tLuaText[LANGUAGE_CONFIG][20956]
...
rwtTask[tSYBCXunCha.Task2]["Title"] = tLuaText[LANGUAGE_CONFIG][20944]
...
rwtTask[tSYBCXunCha.Task2]["AutoTaskDialog"] = tDialogId.Task2
