...
-- rwtNpc[nNPC_SaLind]["ChkEvent"]["ActivityTime"] = {}
-- rwtNpc[nNPC_SaLind]["ChkEvent"]["ActivityTime"][1] = {}
-- rwtNpc[nNPC_SaLind]["ChkEvent"]["ActivityTime"][1]["Type"] = "wday"
-- rwtNpc[nNPC_SaLind]["ChkEvent"]["ActivityTime"][1]["StartTime"] = 4
-- rwtNpc[nNPC_SaLind]["ChkEvent"]["ActivityTime"][1]["EndTime"] = 7
...
rwtNpc[nNPC_SaLind]["ChkEvent"]["Events"][1]["FailEvents"]["CondTime"][1]["StartTime"] = {}
rwtNpc[nNPC_SaLind]["ChkEvent"]["Events"][1]["FailEvents"]["CondTime"][1]["EndTime"] = {}
rwtNpc[nNPC_SaLind]["ChkEvent"]["Events"][1]["FailEvents"]["CondTime"][1]["KaiFuDays"] = {start = 4,ChiXu = 8,JianGe = 7}
