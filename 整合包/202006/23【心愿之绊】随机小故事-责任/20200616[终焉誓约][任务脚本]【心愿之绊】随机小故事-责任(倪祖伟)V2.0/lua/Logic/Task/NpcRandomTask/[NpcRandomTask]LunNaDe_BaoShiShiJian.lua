...
--[[备注--------------------------------------
伦纳德的随机池任务（条件1、自律联盟等级2级；2、完成主线任务10340-银母矿洞）

任务70628前往湖畔镇酒馆的任务，（实际上触发酒馆门前触发陷阱，弹出的对白 13689 含有酒馆的背景34）
注释的npcid： 4478虽然lua文件中没有使用，实际上游戏中是有用到的，在对白 13689 中有商人的出现

任务70630；前往莱伊的家，实际上，进入的是NPC莱伊4480（NPCgroup=10046）的交互
任务对白 13691 和 13692 带有背景图54
--]]-------------------
