--region [System]ChangeMap.lua
--Purpose:		地图切屏
--Creator: 		余锦鑫
--Created:		2018-08-08
--Modifier:		$Author: 孟志远 $
--Modified:		$Date: 20-05-20 $
--RCS-ID:		$Revision: 5 $
--endregion
...
rwtNpcGroup[54031]["ChangeMap"] = {1000, "51.66,22.89,69.93"}
...
rwtNpcGroup[54014]["ChangeMapChk"] = function ()
...
rwtNpcGroup[54014]["UnlockChangeMapFunc"] = function ()
	rwEnterMap(1000,"-37.94,555.14,115.87")
	rwOpenNpcChatDialog(2409)	
end
...
rwtNpcGroup[54032] = {} --四片区→二片区
rwtNpcGroup[54032]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54032]["ChangeMap"] = {2003,"-239.20,0.09,-277.62"}

rwtNpcGroup[54033] = {} --暗道上→暗道下
rwtNpcGroup[54033]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54033]["ChangeMap"] = {2008,"-73.95,-16.06,54.51"}

rwtNpcGroup[54034] = {} --暗道下→暗道上
rwtNpcGroup[54034]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54034]["ChangeMap"] = {2008,"-59.52,-2.40,30.83"}

rwtNpcGroup[54035] = {} --暗崖→鹿角帝国
rwtNpcGroup[54035]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54035]["ChangeMap"] = {2008,"-92.91,-163.21,196.16"}

rwtNpcGroup[54036] = {} --鹿角帝国→暗崖
rwtNpcGroup[54036]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54036]["ChangeMap"] = {2008,"-102.33,-39.61,191.26"}


rwtNpcGroup[54037] = {} --二片区→四片区
rwtNpcGroup[54037]["Type"] = CONST_NPCGROUP_TYPE.ChangeMap
rwtNpcGroup[54037]["ChangeMap"] = {2008,"-27.31,-2.40,29.62"}
