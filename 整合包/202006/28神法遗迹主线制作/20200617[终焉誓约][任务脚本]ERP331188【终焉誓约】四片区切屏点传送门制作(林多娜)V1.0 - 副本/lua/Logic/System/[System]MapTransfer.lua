...
tTransfer[CONST_TRANSFER_INDEX.MAOXIANZHEYINGDI]["tPosInfo"] = {nMapId = 2003, sPos = "4.61,0.16,-25.20"} 
...
--辉麟堡
tTransfer[CONST_TRANSFER_INDEX.HUILINBAO] = {}
tTransfer[CONST_TRANSFER_INDEX.HUILINBAO]["tPosInfo"] = {nMapId = 2008, sPos = "-99.18,0.04,3.69"} 
tTransfer[CONST_TRANSFER_INDEX.HUILINBAO]["OpenTransferTip"] = tLuaText[LANGUAGE_CONFIG][10286]
tTransfer[CONST_TRANSFER_INDEX.HUILINBAO]["ChkFuc"] = function ()
    --判断是否可以解锁传送点
    return true
end
tTransfer[CONST_TRANSFER_INDEX.HUILINBAO]["Funcs"] = {}

--神法遗迹
tTransfer[CONST_TRANSFER_INDEX.SHENFAYIJI] = {}
tTransfer[CONST_TRANSFER_INDEX.SHENFAYIJI]["tPosInfo"] = {nMapId = 2008, sPos = "-105.90,0.00,-28.70"} 
tTransfer[CONST_TRANSFER_INDEX.SHENFAYIJI]["OpenTransferTip"] = tLuaText[LANGUAGE_CONFIG][10287]
tTransfer[CONST_TRANSFER_INDEX.SHENFAYIJI]["ChkFuc"] = function ()
    --判断是否可以解锁传送点
    return true
end
tTransfer[CONST_TRANSFER_INDEX.SHENFAYIJI]["Funcs"] = {}

--暗崖边陲
tTransfer[CONST_TRANSFER_INDEX.ANYABIANCHUI] = {}
tTransfer[CONST_TRANSFER_INDEX.ANYABIANCHUI]["tPosInfo"] = {nMapId = 2008, sPos = "-90.54,-33.98,108.63"} 
tTransfer[CONST_TRANSFER_INDEX.ANYABIANCHUI]["OpenTransferTip"] = tLuaText[LANGUAGE_CONFIG][10288]
tTransfer[CONST_TRANSFER_INDEX.ANYABIANCHUI]["ChkFuc"] = function ()
    --判断是否可以解锁传送点
    return true
end
tTransfer[CONST_TRANSFER_INDEX.ANYABIANCHUI]["Funcs"] = {}
--骨沼战阵
tTransfer[CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN] = {}
tTransfer[CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN]["tPosInfo"] = {nMapId = 2008, sPos = "-71.15,-39.61,139.31"} 
tTransfer[CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN]["OpenTransferTip"] = tLuaText[LANGUAGE_CONFIG][10289]
tTransfer[CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN]["ChkFuc"] = function ()
    --判断是否可以解锁传送点
    return true
end
tTransfer[CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN]["Funcs"] = {}
...
local nTransfer_HuiLinBao = 57019			--辉麟堡
local nTransfer_ShenFaYjJi = 57020			--神法遗迹
local nTransfer_AnYaBianChui = 57021		--暗崖边陲
local nTransfer_GuZhaoZhangZhen = 57022		--骨沼战阵
...
rwtNpcGroup[nTransfer_HuiLinBao] = {} --辉麟堡(传送阵)
rwtNpcGroup[nTransfer_HuiLinBao]["Type"] = CONST_NPCGROUP_TYPE.Transfer
rwtNpcGroup[nTransfer_HuiLinBao]["nIndex"] = CONST_TRANSFER_INDEX.HUILINBAO

rwtNpcGroup[nTransfer_ShenFaYjJi] = {} --神法遗迹(传送阵)
rwtNpcGroup[nTransfer_ShenFaYjJi]["Type"] = CONST_NPCGROUP_TYPE.Transfer
rwtNpcGroup[nTransfer_ShenFaYjJi]["nIndex"] = CONST_TRANSFER_INDEX.SHENFAYIJI

rwtNpcGroup[nTransfer_AnYaBianChui] = {} --暗崖边陲(传送阵)
rwtNpcGroup[nTransfer_AnYaBianChui]["Type"] = CONST_NPCGROUP_TYPE.Transfer
rwtNpcGroup[nTransfer_AnYaBianChui]["nIndex"] = CONST_TRANSFER_INDEX.ANYABIANCHUI

rwtNpcGroup[nTransfer_GuZhaoZhangZhen] = {} --骨沼战阵(传送阵)
rwtNpcGroup[nTransfer_GuZhaoZhangZhen]["Type"] = CONST_NPCGROUP_TYPE.Transfer
rwtNpcGroup[nTransfer_GuZhaoZhangZhen]["nIndex"] = CONST_TRANSFER_INDEX.GUZHAOZHANGZHEN