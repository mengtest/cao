...
rwtNpcGroup[tBox.Normal5]["Type"] = CONST_NPCGROUP_TYPE.Collect
rwtNpcGroup[tBox.Normal5]["CollectTime"] = 2
...
rwtNpcGroup[tBox.Normal5]["Awards"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TIPS
