...
public class MoqiQieHuangZS : EditorWindow {
    public string Path_Client = @"E:\prpr\newyxcs\zysy_env\DataConfigBuild\DataConfigs";
    public string Path_ZhengShi = @"E:\prpr\newyxcs\zysy_env\DataConfigBuild_Official\DataConfigs";

    [MenuItem("脚本工具/万俟工具/1切换正式without_B")]
    ...
    void OnGUI() {
        ...
        if (GUILayout.Button("test", GUILayout.Width(100))) {
            //File.Delete(Path_Client + "\\Languages\\chinese\\" + "12$Dialoges.csv");
        }
    }
}