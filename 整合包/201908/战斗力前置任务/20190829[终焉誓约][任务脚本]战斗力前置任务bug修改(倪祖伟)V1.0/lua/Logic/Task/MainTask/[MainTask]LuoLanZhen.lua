...
--rwtTask[tLuoLanZhen.Task_2]["AcceptExtraTaskId"] = 70212  --暂时屏蔽开宝箱支线任务
...
rwtTask[tLuoLanZhen.Task_30]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.DAILY_TASK,CONST_SYSTEM_FUNCTION.DAILY_COPY_MAP,CONST_SYSTEM_FUNCTION.FIGHTINGPOWER}  --自律联盟,每日副本
