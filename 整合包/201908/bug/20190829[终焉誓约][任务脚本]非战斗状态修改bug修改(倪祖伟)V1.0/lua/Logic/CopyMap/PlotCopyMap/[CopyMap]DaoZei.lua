...
local nBuff_ChangeLookFace = 1002
...
rwtNpcGroup[nTrap_Hide_Boss]["TrapFunc"] = function(NpcGroupType,NpcGroupId,GenEventId)
	...
	if rwUserGetItemCount(nItemId_YaoShui) == 0 then
		...
		rwStatusRemove(nBuff_ChangeLookFace,1)
...
rwtItem[nItemId_YaoShui]["Function"] = function()
	if rwItemDel(nItemId_YaoShui,1) then
		rwSpecialStatus_ChangeLookFace(1,0,0,10022,100,100)
		rwStatusAdd(nBuff_ChangeLookFace)
		rwOpenNpcChatDialog(nDialogs_7)
		rwOpenBubbleView(2400)
		return true
	end
	return false
end
...
--追随者
rwtBubbleGenInfo[3021007] = {}
rwtBubbleGenInfo[3021007]["BubbleText"] = "小心点，今天费玛大人的心情不好。"
rwtBubbleGenInfo[3021007]["BubbleMode"] = 0 
rwtBubbleGenInfo[3021007]["BubbleTime"] = 2400

--雇佣兵
rwtBubbleGenInfo[3021006] = {}
rwtBubbleGenInfo[3021006]["BubbleText"] = "是来换班的吗？还没有到时间啊。"
rwtBubbleGenInfo[3021006]["BubbleMode"] = 0 
rwtBubbleGenInfo[3021006]["BubbleTime"] = 2400
