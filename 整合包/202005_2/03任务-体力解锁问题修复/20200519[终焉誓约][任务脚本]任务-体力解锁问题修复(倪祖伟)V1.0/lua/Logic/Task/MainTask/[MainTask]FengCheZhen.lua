...
--自律联盟前置任务
local nBranchTask_ZiLvLianMengPre = 70518
...
rwtNpc[tFengChe.nNpcres_ZuoYi]["DialogId"] = {61112}
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"] = {}
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"][1] = {}
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"][1]["Title"]= tLuaText[LANGUAGE_CONFIG][40059]
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"][1]["State"] = 1
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"][1]["Chk"] = function(nNpcId)
    return true
end
rwtNpc[tFengChe.nNpcres_ZuoYi]["Option"][1]["Func"] = function(nNpcTypeId)  --点击按钮触发
     rwOpenNpcChatDialog(61113,CONST_NPCCHAT_TYPE.ACTIVITY)
end
------------------------------------------Moster_GenId     
...
rwtTask[tFengChe.Task13]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.ZHOUHUIFUBEN,CONST_SYSTEM_FUNCTION.STRENGTHEN,CONST_SYSTEM_FUNCTION.AP}
...
rwtTask[tFengChe.Task17]["AcceptExtraTaskId"] = {70468} --温丽梦境支线
...
rwtTask[tFengChe.Task18]["AcceptExtraTaskId"] = {70228} --奥兹家族支线
...
rwtTask[tFengChe.Task18]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.AOZI,CONST_SYSTEM_FUNCTION.DREAM_LAND}  --解锁奥兹家族
...
rwtTask[tFengChe.Task19]["AcceptExtraTaskId"] = {nBranchTask_ZiLvLianMengPre} --支线后解锁委托任务、公会系统
...
rwtTask[tFengChe.Task19]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.WENJUAN2} --问卷2
...
rwtTask[tFengChe.Task20]["TaskDetailType"] = CONST_TASK_DETAIL_TYPE.DEFAULT
rwtTask[tFengChe.Task20]["IsClickComplete"] = 1
--rwtTask[tFengChe.Task20]["NeedLeagueLevel"] = 2
rwtTask[tFengChe.Task20]["TaskDialogTips"] = 10714
rwtTask[tFengChe.Task20]["AcceptFunc"] = function()
    rwOpenNpcChatDialog(10714,CONST_NPCCHAT_TYPE.TASK, tFengChe.Task20)
end

--自律联盟前置支线任务列表
local tZiLvLianMengPreTaskList = {70518,70515,70517,70516,70519,40132,40162}

rwtDialog[10714] = {}
rwtDialog[10714]["OptionFunc1"] = function(nIndex,nType,nId,nOptionIndex)
    for i,nTaskId in ipairs(tZiLvLianMengPreTaskList) do
...
rwtTask[tFengChe.Task20]["DynaNpcGroupGen"][1]["DelType"] = CONST_TASK_INFO_DELTYPE.NotDel
--rwtTask[tFengChe.Task20]["DialogId"] = 10715
--rwtTask[tFengChe.Task20]["StartGuide"] = 124
--rwtTask[tFengChe.Task20]["StartGuideType"] = 1
rwtTask[tFengChe.Task20]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.DAILY_COPY_MAP}  --解锁联盟特派任务
...
rwtTask[tFengChe.Task21]["DynaNpcGroupGen"] = {}
rwtTask[tFengChe.Task21]["DynaNpcGroupGen"][1] = {}
rwtTask[tFengChe.Task21]["DynaNpcGroupGen"][1]["GenId"] = 1000252
rwtTask[tFengChe.Task21]["DynaNpcGroupGen"][1]["MapId"] = 1000
rwtTask[tFengChe.Task21]["DynaNpcGroupGen"][1]["DelType"] = CONST_TASK_INFO_DELTYPE.NotDel
...
rwtTask[tFengChe.Task21]["StartAutoWay"]["FindWayGroupId"] = 21037
rwtTask[tFengChe.Task21]["StartAutoWay"]["FindWayGenId"] = 1000252
