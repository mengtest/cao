...
-- 掩码 1023 data2 = 1 时播放引导；完成后设置为离开 1023 data2 = 2
    ...
    rwtDialog[12372]["DialogEndInit"] = {}
    rwtDialog[12372]["DialogEndInit"]["Events"] = {}
    rwtDialog[12372]["DialogEndInit"]["Events"][1] = {}
    rwtDialog[12372]["DialogEndInit"]["Events"][1]["GetServerAward"] = {}
    rwtDialog[12372]["DialogEndInit"]["Events"][1]["GetServerAward"]["AwardType"] = CONST_AWARD_TYPE.AWARD
    rwtDialog[12372]["DialogEndInit"]["Events"][1]["GetServerAward"]["AwardId"] = 6000000
    rwtDialog[12372]["DialogEndInit"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TREASURE_BOX
    ...
    tPuzzleEvent[101][101006]["ReqObjMsg"] = 101106
    ...
    tPuzzleEvent[101][101013] = {} --解谜屋的提示光效-灯
    tPuzzleEvent[101][101013]["InTask"] = 10109
    tPuzzleEvent[101][101013]["RemoveOutLineEffect"] = 101028
