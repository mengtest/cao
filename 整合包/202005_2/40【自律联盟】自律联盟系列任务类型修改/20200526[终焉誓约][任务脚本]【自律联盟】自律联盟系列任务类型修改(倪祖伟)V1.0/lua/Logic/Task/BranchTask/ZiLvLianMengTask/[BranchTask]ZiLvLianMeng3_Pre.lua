...
tZiLvLianMengAwardId[1]  =	2000799
tZiLvLianMengAwardId[2]  =	2000800
tZiLvLianMengAwardId[3]  =	2000801

function rwtZiLvLianMeng3_Task()
    if not rwTaskIsAccept(tTask.nZiLvLianMeng_Pre1) and not rwTaskIsSuccess(tTask.nZiLvLianMeng_Pre1) then
        rwLinkTaskAccept(tTask.nZiLvLianMeng_Pre1)
    end
end

rwtLeagueLevelUp_Func[5] = rwtLeagueLevelUp_Func[5] or {}
table.insert(rwtLeagueLevelUp_Func[5],rwtZiLvLianMeng3_Task)
...
rwtTask[tTask.nZiLvLianMeng_Pre2]["TaskType"] = CONST_TASK_TYPE.LIANMENG
...
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1] = {}
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1]["GetServerAward"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1]["GetServerAward"]["AwardType"] = CONST_AWARD_TYPE.AWARD
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1]["GetServerAward"]["AwardId"] = tZiLvLianMengAwardId[1]
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TASK
rwtTask[tTask.nZiLvLianMeng_Pre2]["Awards"]["Events"][1]["GetServerAward"]["ActionId"] = tTask.nZiLvLianMeng_Pre2
...
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1] = {}
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["LeagueExp"] = 100
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["GetServerAward"] = {}
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["GetServerAward"]["AwardType"] = CONST_AWARD_TYPE.AWARD
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["GetServerAward"]["AwardId"] = tZiLvLianMengAwardId[2]
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TASK
rwtTask[tTask.nZiLvLianMeng_Pre6]["Awards"]["Events"][1]["GetServerAward"]["ActionId"] = tTask.nZiLvLianMeng_Pre6

rwtTask[tTask.nZiLvLianMeng_Pre7] = {}
rwtTask[tTask.nZiLvLianMeng_Pre7]["Title"] = tLuaText[LANGUAGE_CONFIG][22015]
rwtTask[tTask.nZiLvLianMeng_Pre7]["TaskType"] = CONST_TASK_TYPE.LIANMENG
...
rwtTask[tTask.nZiLvLianMeng_Pre8]["TaskType"] = CONST_TASK_TYPE.LIANMENG
...
rwtTask[tTask.nZiLvLianMeng_Pre9]["TaskType"] = CONST_TASK_TYPE.LIANMENG
...
rwtTask[tTask.nZiLvLianMeng_Pre9]["Awards"]["Events"][1]["LeagueExp"] = 200
...
rwtTask[tTask.nZiLvLianMeng_Pre9]["Awards"]["Events"][1]["GetServerAward"]["AwardId"] = tZiLvLianMengAwardId[3]
