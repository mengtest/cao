...
--data7 = 法阵状态：0：开始解谜阶段（触发爱琳娜对白）；2：第一次采集；3：正式开始；
...
function rwCopyMapAoZiJiaZu_PassFaZhen()
    ...
    for i,v in ipairs(tPos) do
        rwSpecialStatus_AddEffect(7,0, tEffecInfo.Ming, v,0,35)
    end
end
...
-- rwtNpcGroup[tNpcGroup.TrapFZ]["Awards"]["Events"][2]["ChkUserTempData"][1]["Value"] = 0
...
rwtDialog[tDialog.FaZeNoClU] = rwtDialog[tDialog.FaZeNoClU] or {}
rwtDialog[tDialog.FaZeNoClU]["DialogEndInit"] = {}
rwtDialog[tDialog.FaZeNoClU]["DialogEndInit"]["Events"] = {}
rwtDialog[tDialog.FaZeNoClU]["DialogEndInit"]["Events"][1] = {}
rwtDialog[tDialog.FaZeNoClU]["DialogEndInit"]["Events"][1]["DynCreate"] = {3148001,3148002,3148003,3148004,3148005}
rwtDialog[tDialog.FaZeNoClU]["DialogEndInit"]["Events"][1]["DynDelete"] = {3148007}
