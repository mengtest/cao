...
rwtTask[tFengChe.Task18]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.AOZI}  --解锁奥兹家族
...
--            ENUM_TASK_TEMPLATE[nTaskDetailType]:create(nTaskId):OnTaskPanelClick()
	...
	if not bIsAccpetTask then
		local data = "1 1000 70011 1000151"
		rwFindWay(data)
	end
end
