...
rwtTask[tLuoLanZhen.Task_1]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.PLAYER_TRAINING}  --玩家训练(战技研习)
...
rwtTask[tLuoLanZhen.Task_9]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.SHOP,CONST_SYSTEM_FUNCTION.HERO_LOTTERY,CONST_SYSTEM_FUNCTION.HRO_UP_CLASS} --商城，抽卡,英雄突破
