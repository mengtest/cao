...
rwtTask[tLuoLanZhen.Task_9]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.HERO_LOTTERY,CONST_SYSTEM_FUNCTION.HRO_UP_CLASS} --抽卡,英雄突破
...
rwtTask[tLuoLanZhen.Task_17]["StartAutoWay"]["FindWayGroupId"] = nTrap_14
rwtTask[tLuoLanZhen.Task_17]["StartAutoWay"]["FindWayGenId"] = nTrap_GenId_14
...
rwtTask[tLuoLanZhen.Task_30]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.DAILY_TASK,CONST_SYSTEM_FUNCTION.DAILY_COPY_MAP,CONST_SYSTEM_FUNCTION.ZHOUHUIFUBEN}  --自律联盟,每日副本,周回副本
