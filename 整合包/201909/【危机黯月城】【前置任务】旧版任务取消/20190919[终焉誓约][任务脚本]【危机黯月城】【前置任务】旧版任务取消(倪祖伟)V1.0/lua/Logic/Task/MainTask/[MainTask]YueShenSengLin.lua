--region [MainTask]YueShenSengLin.lua
--Purpose:		月神森林主线
--Creator: 		黄艳婷
--Created:		2018-08-07
--Modifier:		$Author: 倪祖伟 $
--Modified:		$Date: 19-09-19 $
--RCS-ID:		$Revision: 6 $
--endregion
...
--倒计时相关
--倒计时加速物品id
local nSpeedItem = 7000270
--卡点任务无道具提示
local sLackTips = tLuaText[LANGUAGE_CONFIG][10223]
--提交道具对白
local nSpeedDialog = 12956
--副本掉落奖励
local nSpeedAwardId = 1000817
...
rwtNpc[nNpc_MuChan1]["Option"] = {}
rwtNpc[nNpc_MuChan1]["Option"][1] = {}
rwtNpc[nNpc_MuChan1]["Option"][1]["Title"]= tLuaText[LANGUAGE_CONFIG][40023]
rwtNpc[nNpc_MuChan1]["Option"][1]["State"] = 0
rwtNpc[nNpc_MuChan1]["Option"][1]["Chk"] = function(nNpcId)
    if rwCountDownTaskChkUserInTask(tYueShenSengLinTask[22]) then
        return true
    end
    return false
end
rwtNpc[nNpc_MuChan1]["Option"][1]["Func"] = function(nNpcTypeId) --点击按钮触发
    rwCountDownSpeedLogic(tYueShenSengLinTask[22])
end
...
rwtTask[tYueShenSengLinTask[14]]["UnLockZhouHui"] = 3041
...
rwtTask[tYueShenSengLinTask[22]]["DropCopyMapId"] = {3041}
rwtTask[tYueShenSengLinTask[22]]["DropAwardId"] = nSpeedAwardId

rwtTask[tYueShenSengLinTask[22]]["CountDownSpeed"] = {}
rwtTask[tYueShenSengLinTask[22]]["CountDownSpeed"]["SpeedItem"] = nSpeedItem
rwtTask[tYueShenSengLinTask[22]]["CountDownSpeed"]["SpeedDialog"] = nSpeedDialog
rwtTask[tYueShenSengLinTask[22]]["CountDownSpeed"]["LackTips"] = sLackTips

rwtTask[tYueShenSengLinTask[22]]["Awards"] = {}
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"] = {}
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1] = {}
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["DeleteItem"] = {}
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["DeleteItem"]["ItemId"] = nSpeedItem
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["DeleteItem"]["DeleteAll"] = 1
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["GetServerAward"] = {}
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["GetServerAward"]["AwardType"] = CONST_AWARD_TYPE.AWARD
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["GetServerAward"]["AwardId"] = 2000611
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TASK
rwtTask[tYueShenSengLinTask[22]]["Awards"]["Events"][1]["GetServerAward"]["ActionId"] = tYueShenSengLinTask[22]
...
-- rwtTask[tYueShenSengLinTask[24]]["AcceptExtraTaskId"] = {70219}
...
rwtTask[tYueShenSengLinTask[24]]["UnLockSysId"] = {CONST_SYSTEM_FUNCTION.MULTI_HERO_COPYMAP}   --多英雄解锁
--------------------------------------------------------------------------------
