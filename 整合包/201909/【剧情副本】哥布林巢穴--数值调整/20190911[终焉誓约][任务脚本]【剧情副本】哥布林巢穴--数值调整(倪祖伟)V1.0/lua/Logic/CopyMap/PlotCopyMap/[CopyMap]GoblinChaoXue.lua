...
--物品ID
local nItemID_1 = 7000001 -- 隐身
-- local nItemID_2 = 7000021
local nItemID_3 = 7000022 -- 宁静药剂
...
rwtDialog[5281]["DialogEndInit"]["Events"][1]["GetServerAward"]["ActionType"] = CONST_ACTION_TYPE.TIPS
...
rwtDialog[5281]["DialogEndInit"]["Events"][1]["GetServerAward"]["AwardId"] = 1000065
...
rwtCopyMapMission[nCopyMapMissId_1]["CopyMapTitle"] = "哥布林巢穴（剧情）"
